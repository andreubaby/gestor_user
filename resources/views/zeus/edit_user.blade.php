...
<div class="text-right mb-6">
    ...
    @else
        <a href="{{ route('usuarios.vincular', ['trabajador_id' => $userZeus->id]) }}"
...
<div class="max-w-3xl mx-auto bg-white p-6 rounded-xl shadow">
    <h1 class="text-2xl font-bold text-primary mb-6">Editar Usuario Zeus</h1>

    <form method="POST" action="{{ route('semillas.user.update', $userZeus->id) }}">
        @csrf
        @method('PUT')
