...
<div class="text-right mb-6">
    ...
    @else
        <a href="{{ route('usuarios.vincular', ['trabajador_id' => $userCronos->id]) }}"
...
<div class="max-w-3xl mx-auto bg-white p-6 rounded-xl shadow">
    <h1 class="text-2xl font-bold text-primary mb-6">Editar Usuario Buscador</h1>

    <form method="POST" action="{{ route('cronos.user.update', $userCronos->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input type="text" id="name" name="name"
                   value="{{ old('name', $userCronos->name) }}"
