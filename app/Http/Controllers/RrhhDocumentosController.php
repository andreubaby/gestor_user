...
class RrhhDocumentosController extends Controller
{
    ...
    private function buildPdfForTipo(string $tipo, TrabajadorPolifonia $t, string $puesto, string $fecha, string $templateAbs): ?string
    {
        return match ($tipo) {
            ...
            'cursos_formacion'                  => $this->buildCursosFormacion($t, $fecha, $puesto, $templateAbs, $tipo),
            'plan_estres_termico'               => $this->buildPlanEstresTermico($t, $fecha, $puesto, $templateAbs, $tipo),
            default => null,
        };
    }
    ...
    private function buildCursosFormacion(
        TrabajadorPolifonia $t,
        string $fecha,
        string $puesto,
        string $templateAbs,
    ...
    private function buildPlanEstresTermico(
        TrabajadorPolifonia $t,
        string $fecha,
        string $puesto,
        string $templateAbs,
